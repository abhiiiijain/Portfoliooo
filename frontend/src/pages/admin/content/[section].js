...
import { contentEditorSections } from "@/lib/adminSections";

export default function AdminContentEditor() {
  const router = useRouter();
  const section = contentEditorSections[router.query.section];

  if (!section) {
    return (
      <AdminLayout title="Section not found" subtitle="This admin section does not exist">
